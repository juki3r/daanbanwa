...
<div class="d-none d-md-flex flex-column h-100 bg-white border-end p-3">
    ...
    <nav class="nav flex-column gap-1">
        ...
        class="nav-link d-flex align-items-center gap-1 {{ request()->routeIs('residents.*') ? 'active-nav' : 'text-dark' }}">
            <i class="bi bi-people-fill"></i>
            <span>Residents</span>
        </a>

        <a href="{{ route('requests.index') }}"
            class="nav-link d-flex align-items-center gap-1 {{ request()->routeIs('requests.index') ? 'active-nav' : 'text-dark' }}">
        ...
        class="nav-link d-flex align-items-center gap-1 {{ request()->routeIs('concerns.*') ? 'active-nav' : 'text-dark' }}">
            <span class="nav-icon-wrapper">
        ...
        class="nav-link d-flex align-items-center gap-1 {{ request()->routeIs('blotters.*') ? 'active-nav' : 'text-dark' }}">
            <span class="nav-icon-wrapper">
        ...
        class="nav-link d-flex align-items-center gap-1 {{ request()->routeIs('users.*') ? 'active-nav' : 'text-dark' }}">
            <i class="bi bi-phone-fill"></i>
            <span>App Users</span>
        </a>

        <a href="{{ route('news.index') }}"
        class="nav-link d-flex align-items-center gap-1 {{ request()->routeIs('news.*') ? 'active-nav' : 'text-dark' }}">
            <i class="bi bi-newspaper"></i>
            <span>News</span>
        </a>

        <a href="{{ route('ordinances.index') }}"
        class="nav-link d-flex align-items-center gap-1 {{ request()->routeIs('ordinances.*') ? 'active-nav' : 'text-dark' }}">
            <i class="bi bi-newspaper"></i>
            <span>Ordinances</span>
        </a>

        <a href="{{ route('officials.index') }}"
        class="nav-link d-flex align-items-center gap-1 {{ request()->routeIs('officials.*') ? 'active-nav' : 'text-dark' }}">
            <i class="bi bi-people"></i>
            <span>Officials</span>
        </a>

        <a href="{{ route('emergency.index') }}"
        class="nav-link d-flex align-items-center gap-1 {{ request()->routeIs('emergency.*') ? 'active-nav' : 'text-dark' }}">
            <i class="bi bi-telephone-fill"></i>
            <span>Emergency</span>
        </a>

        <a href="{{ route('calendar.index') }}"
        class="nav-link d-flex align-items-center gap-1 {{ request()->routeIs('calendar.*') ? 'active-nav' : 'text-dark' }}">
